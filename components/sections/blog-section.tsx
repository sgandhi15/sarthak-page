      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts.map((post, index) => (
            ...
            >
              <div className="text-xs text-gray-500 font-space absolute mt-2 ml-2 bg-[#1A1A1A] px-2 z-10">
                <span className="text-gray-500">{`<Card component="BlogPost" id="post-${index}" />`}</span>
              </div>
              <div className="relative overflow-hidden">
                ...
                <div className="absolute top-0 left-0 bg-green-400 text-[#121212] px-3 py-1 font-space text-xs">
                  <span className="flex items-center">
                    ...
                    <span className="text-xs text-[#121212] font-space mr-1">posts[{index}].date:</span>
                    {post.date}
                  </span>
                </div>
              </div>
              ...
              <div className="p-6">
                <div className="flex items-center mb-3 text-xs text-gray-400">
                  <span className="flex items-center mr-4">
                    ...
                    <span className="text-xs text-gray-400 font-space mr-1">posts[{index}].read_time:</span>
                    {post.readTime}
                  </span>
                  <span className="flex items-center">
                    <Tag className="w-3 h-3 mr-1" />
                    <span className="text-xs text-gray-400 font-space mr-1">posts[{index}].primary_tag:</span>
                    {post.tags[0]}
                  </span>
                </div>
                ...
                <div className="text-xs text-purple-400 font-space mb-1">
                  <span>posts[{index}].excerpt:</span>
                </div>
        ...
        <div className="mt-12 text-center animate-on-scroll opacity-0 translate-y-10 transition-all duration-700 delay-1000">
          ...
          <div className="text-xs text-gray-500 mt-2 font-space">
            <span className="text-gray-500">{`<Button component="ViewAllButton" route="/blog" />`}</span>
          </div>
        </div>
      </div>
    </section>
